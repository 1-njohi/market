...
Route::post('/result', function(Request $request) {
    return response() -> json(generateRandomFixture(null, $request -> fixture_id));
});
...
function generateRandomFixture($fixture = null, $fixture_id)
    {
        ...
        if ($homeHalftime > $homeGoals) $homeHalftime = $homeGoals;
        if ($awayHalftime > $awayGoals) $awayHalftime = $awayGoals;
    ...
    {
        $referees = [
            'A. Taylor', 'M. Oliver', 'S. Attwell', 'C. Pawson', 
            'D. England', 'J. Moss', 'P. Tierney', 'S. Hooper',
            'K. Friend', 'A. Madley', 'R. Jones', 'G. Scott'
        ];
    ...
    {
        $venues = [
            'Old Trafford', 'Anfield', 'Emirates Stadium', 'Stamford Bridge',
            'Etihad Stadium', 'Tottenham Hotspur Stadium', 'St. James\' Park',
            'Villa Park', 'Goodison Park', 'Elland Road', 'Selhurst Park'
        ];
    ...
    function getRandomCity()
    {
        $cities = [
            ...
            'Newcastle', 'Sheffield', 'Nottingham', 'Southampton', 'Brighton'
        ];
    ...
    function getRandomTeam()
    {
        $teams = [
            ...
            'Manchester City', 'Tottenham', 'Newcastle United', 'Aston Villa',
            'Everton', 'Leeds United', 'Crystal Palace', 'West Ham United'
        ];
